 ...
 */
package apps.basilisk.kunatickerwidget.billing.skulist.row;

import com.android.billingclient.api.BillingClient.SkuType;
import com.android.billingclient.api.SkuDetails;
import apps.basilisk.kunatickerwidget.billing.skulist.SkusAdapter;
import apps.basilisk.kunatickerwidget.billing.skulist.SkusAdapter.RowTypeDef;
...
public class SkuRowData {
    ...
    public SkuRowData(SkuDetails details, @RowTypeDef int rowType,
        ...
        this.priceAmountMicros = details.getPriceAmountMicros();
    }
