...
/**
 * Handles Ui specific to "6 months" - subscription row
 */
public class SixMonthsDelegate extends UiManagingDelegate {
    public static final String SKU_ID = BillingConstants.SKU_PRIVATE_API_6_MONTHS;

    public SixMonthsDelegate(BillingProvider billingProvider) {
    ...
    public void onBindViewHolder(SkuRowData data, RowViewHolder holder) {
        ...
        holder.skuIcon.setImageResource(R.drawable.private_api_6_months);
    }
