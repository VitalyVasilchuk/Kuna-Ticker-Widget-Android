...
/**
 * Handles Ui specific to "1 year" - subscription row
 */
public class YearDelegate extends UiManagingDelegate {
    public static final String SKU_ID = BillingConstants.SKU_PRIVATE_API_1_YEAR;

    public YearDelegate(BillingProvider billingProvider) {
    ...
    public void onBindViewHolder(SkuRowData data, RowViewHolder holder) {
        ...
        holder.skuIcon.setImageResource(R.drawable.private_api_1_year);
    }
