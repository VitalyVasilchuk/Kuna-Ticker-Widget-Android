...
/**
 * Handles Ui specific to "1 week" - subscription row
 */
public class WeekDelegate extends UiManagingDelegate {
    public static final String SKU_ID = BillingConstants.SKU_PRIVATE_API_1_WEEK;

    public WeekDelegate(BillingProvider billingProvider) {
    ...
    public void onBindViewHolder(SkuRowData data, RowViewHolder holder) {
        ...
        holder.skuIcon.setImageResource(R.drawable.private_api_1_week);
    }
