...
/**
 * Handles Ui specific to "3 months" - subscription row
 */
public class ThreeMonthsDelegate extends UiManagingDelegate {
    public static final String SKU_ID = BillingConstants.SKU_PRIVATE_API_3_MONTHS;

    public ThreeMonthsDelegate(BillingProvider billingProvider) {
    ...
    public void onBindViewHolder(SkuRowData data, RowViewHolder holder) {
        ...
        holder.skuIcon.setImageResource(R.drawable.private_api_3_months);
    }
